...
metrics['RunningContainers']	= { id: 'XXX:RunningContainers:4', 	ratio: false, object : false, output : true, get : function(data, runningContainers) { return runningContainers; } };

metrics['ReceivedBytes']		= { id: 'XXX:ReceivedBytes:4', 		ratio: true, object : true, output : true, get : function(data) { return (data.network.rx_bytes / 1024 / 1024).toFixed(2); } };
metrics['ReceivedErrors']		= { id: 'XXX:ReceivedErrors:4', 	ratio: true, object : true, output : true, get : function(data) { return data.network.rx_errors; } };
metrics['ReceivedDropped']		= { id: 'XXX:ReceivedDropped:4', 	ratio: true, object : true, output : true, get : function(data) { return data.network.rx_dropped; } };
metrics['TransmittedBytes']		= { id: 'XXX:TransmittedBytes:4', 	ratio: true, object : true, output : true, get : function(data) { return (data.network.tx_bytes / 1024 / 1024).toFixed(2); } };
metrics['TransmittedErrors']	= { id: 'XXX:TransmittedErrors:4', 	ratio: true, object : true, output : true, get : function(data) { return data.network.tx_errors; } };
metrics['TransmittedDropped']	= { id: 'XXX:TransmittedDropped:4', ratio: true, object : true, output : true, get : function(data) { return data.network.tx_dropped; } };

metrics['CPUTotalUsage']		= { id: 'XXX:CPUTotalUsage:4', 		ratio: true, object : true, output : true, get : function(data) { return data.cpu_stats.cpu_usage.total_usage; } };
metrics['CPUUsageKernal']		= { id: 'XXX:CPUUsageKernal:4',		ratio: true, object : true, output : true, get : function(data) { return data.cpu_stats.cpu_usage.usage_in_kernelmode; } };
metrics['CPUUsageUser']			= { id: 'XXX:CPUUsageUser:4', 		ratio: true, object : true, output : true, get : function(data) { return data.cpu_stats.cpu_usage.usage_in_usermode; } };
...
metrics['MemoryUsage']			= { id: 'XXX:MemoryUsage:4', 		ratio: false, object : true, output : true, get : function(data) { return (data.memory_stats.usage / 1024 / 1024).toFixed(2); } };
metrics['MemoryCache']			= { id: 'XXX:MemoryCache:4', 		ratio: false, object : true, output : true, get : function(data) { return (data.memory_stats.stats.cache / 1024 / 1024).toFixed(2); } };
metrics['MemoryRss']			= { id: 'XXX:MemoryRss:4', 			ratio: false, object : true, output : true, get : function(data) { return (data.memory_stats.stats.rss / 1024 / 1024).toFixed(2); } };
//metrics['MemoryLimit']			= { id: 'XXX:MemoryLimit:4', 		ratio: false, object : true, output : true, get : function(data) { return (data.memory_stats.limit / 1024 / 1024).toFixed(2); } };

metrics['IORead']				= { id: 'XXX:IORead:4', 			ratio: true, object : true, output : true, get : function(data) { return data.blkio_stats.io_service_bytes_recursive[0].value; } }; // TODO Change indexes
metrics['IOWrite']				= { id: 'XXX:IOWrite:4', 			ratio: true, object : true, output : true, get : function(data) { return data.blkio_stats.io_service_bytes_recursive[1].value; } };
metrics['IOAsync']				= { id: 'XXX:IOAsync:4', 			ratio: true, object : true, output : true, get : function(data) { return data.blkio_stats.io_service_bytes_recursive[3].value; } };
metrics['IOSync']				= { id: 'XXX:IOSync:4', 			ratio: true, object : true, output : true, get : function(data) { return data.blkio_stats.io_service_bytes_recursive[2].value; } };

var tempDir = '/tmp';
var defaultSocker = '/var/run/docker.sock';
var request, client, containers, images, response = '', processed = 0;
...
function match(matchValues, matchList)
{
	...
	for (var i = 0; i < matchList.length; i++)
	{
		...
		for (var j = 0; j < matchValues.length; j++)
		{
			...
			if (matchValue.toLowerCase().indexOf(match.trim().toLowerCase()) !== -1)
			{
				return true;
			}
		}
...
function getDelta(initMetric, endMetric, initMetrics, endMetrics)
{
	...
	if (initMetric.variableName === 'CPUTotalUsage' || initMetric.variableName === 'CPUUsageUser' || initMetric.variableName === 'CPUUsageKernal')
	{
