...
metrics['RunningContainers']	= { id: '1986:Running Containers:4',		ratio: false, object : false, output : true, get : function(data, runningContainers) { return runningContainers; } };

metrics['ReceivedBytes']		= { id: '1987:Network Bytes In/Sec:4',		ratio: true, object : true, output : true, get : function(data) { return (data.network.rx_bytes / 1024 / 1024).toFixed(2); } };
metrics['ReceivedErrors']		= { id: '1988:Network Errors In/Sec:4',		ratio: true, object : true, output : true, get : function(data) { return data.network.rx_errors; } };
metrics['ReceivedDropped']		= { id: '1989:Network Drops In/Sec:4',		ratio: true, object : true, output : true, get : function(data) { return data.network.rx_dropped; } };
metrics['TransmittedBytes']		= { id: '1990:Network Bytes Out/Sec:4',		ratio: true, object : true, output : true, get : function(data) { return (data.network.tx_bytes / 1024 / 1024).toFixed(2); } };
metrics['TransmittedErrors']	= { id: '1991:Network Errors Out/Sec:4',	ratio: true, object : true, output : true, get : function(data) { return data.network.tx_errors; } };
metrics['TransmittedDropped']	= { id: '1992:Network Drops Out/Sec:4',		ratio: true, object : true, output : true, get : function(data) { return data.network.tx_dropped; } };

metrics['CPUTotalUsage']		= { id: '1993:% CPU Total:4',				ratio: true, object : true, output : true, get : function(data) { return data.cpu_stats.cpu_usage.total_usage; } };
metrics['CPUUsageKernel']		= { id: '1994:% CPU Kernel:4',				ratio: true, object : true, output : true, get : function(data) { return data.cpu_stats.cpu_usage.usage_in_kernelmode; } };
metrics['CPUUsageUser']			= { id: '1995:% CPU User:4',				ratio: true, object : true, output : true, get : function(data) { return data.cpu_stats.cpu_usage.usage_in_usermode; } };
...
metrics['MemoryUsage']			= { id: '1996:Memory Usage:4',				ratio: false, object : true, output : true, get : function(data) { return (data.memory_stats.usage / 1024 / 1024).toFixed(2); } };
metrics['MemoryCache']			= { id: '1997:Memory Cache:4',				ratio: false, object : true, output : true, get : function(data) { return (data.memory_stats.stats.cache / 1024 / 1024).toFixed(2); } };
metrics['MemoryRss']			= { id: '1998:Memory RSS:4',				ratio: false, object : true, output : true, get : function(data) { return (data.memory_stats.stats.rss / 1024 / 1024).toFixed(2); } };

metrics['IORead']				= { id: '1999:IO Bytes Read/Sec:4',			ratio: true, object : true, output : true, get : function(data) { return (data.blkio_stats.io_service_bytes_recursive[0].value / 1024 / 1024).toFixed(2); } };
metrics['IOWrite']				= { id: '2000:IO Bytes Write/Sec:4',		ratio: true, object : true, output : true, get : function(data) { return (data.blkio_stats.io_service_bytes_recursive[1].value / 1024 / 1024).toFixed(2); } };
metrics['IOAsync']				= { id: '2001:IO Bytes Async/Sec:4',		ratio: true, object : true, output : true, get : function(data) { return (data.blkio_stats.io_service_bytes_recursive[3].value / 1024 / 1024).toFixed(2); } };
metrics['IOSync']				= { id: '2002:IO Bytes Sync/Sec:4',			ratio: true, object : true, output : true, get : function(data) { return (data.blkio_stats.io_service_bytes_recursive[2].value / 1024 / 1024).toFixed(2); } };
